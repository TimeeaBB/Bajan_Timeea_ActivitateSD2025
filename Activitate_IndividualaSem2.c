...
//}
//
//// Copiază primele N laptopuri într-un nou vector
...
//}
//
//// Copiază laptopurile cu minim 16GB RAM (Asa mi-am propus ca si  exercitiu)
//void copiazaAnumiteElemente(struct Laptop* vector, int nrElemente, int prag, struct Laptop** vectorNou, int* dimensiune) {
//    *dimensiune = 0;
//
//    // Determinăm câte laptopuri respectă condiția (minim 16GB RAM)
//    for (int i = 0; i < nrElemente; i++) {
...
//}
//
//// Găsește primul laptop după producator
...
//            return vector[i]; // Returnam un shallow copy (fara alocare de memorie noua)
//        }  // shallow copy = copiază doar adresele de memorie ale pointerilor, nu și datele la care aceștia fac referire.
//    }
...
//    dezalocare(&vectorCopiat, &nrElemCopiate);
//
//    // Găsim un laptop după marcă (de exemplu APPLE)
